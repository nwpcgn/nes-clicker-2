...
<TabControl bind:this={tabcontrol}>
	...
	<div class="stack">
		<TabControlItem
			...
			<button
				on:click={() => {
					tabcontrol.setTab('address')
					inactive.address = false
				}}>Next</button>
		</TabControlItem>
		<TabControlItem id="address" payload="Address" disabled={inactive.address}>
			...
			<button
				on:click={() => {
					tabcontrol.setTab('payment')
					inactive.payment = false
				}}>Next</button>
		</TabControlItem>
		<TabControlItem id="payment" payload="Payment" disabled={inactive.payment}>
			...
			<button
				on:click={() => {
					tabcontrol.setTab('summary')
					inactive.summary = false
				}}>Next</button>
		</TabControlItem>
